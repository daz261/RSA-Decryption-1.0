...
public class CameraSource {
    ...
    private final com.example.mlkit_barcode_ocr.utility.GraphicOverlay graphicOverlay;
    ...
    private com.example.mlkit_barcode_ocr.utility.VisionImageProcessor frameProcessor;
    ...
    public CameraSource(Activity activity, com.example.mlkit_barcode_ocr.utility.GraphicOverlay overlay) {
    ...
    public void setMachineLearningFrameProcessor(com.example.mlkit_barcode_ocr.utility.VisionImageProcessor processor) {
        synchronized (processorLock) {
            cleanScreen();
            if (frameProcessor != null) {
                frameProcessor.stop();
                ...
                try {
                    synchronized (processorLock) {
                        ...
                        frameProcessor.process(
                                data,
                                new com.example.mlkit_barcode_ocr.utility.FrameMetadata.Builder()
