 ...
 * </ol>
 */
public class OcrGraphic<T extends OcrGraphic.Graphic> extends View {
     ...
     * graphics element.  Add instances to the overlay using {@link OcrGraphic#add(Graphic)}.
     */
    public static abstract class Graphic {
        private OcrGraphic mOverlay;

        public Graphic(OcrGraphic overlay) {
            mOverlay = overlay;
        }
    ...
    public OcrGraphic(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
